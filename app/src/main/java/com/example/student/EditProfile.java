                    ...
                    .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.getResult().exists()) {
                                ...
                                String ID_res = task.getResult().getString("ID");
                                String branch_res = task.getResult().getString("branch");
                                String city_res = task.getResult().getString("city");
                                String contact_res = task.getResult().getString("contact");
                                String Url = task.getResult().getString("url");

                                Picasso.get().load(Url).into(imageView);

                                ed_name.setText(name_res);
                                ed_ID.setText(ID_res);
                                ed_branch.setText(branch_res);
                                ed_city.setText(city_res);
                                ed_contact.setText(contact_res);
